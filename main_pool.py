...
if __name__ == '__main__':
    ...
    try:
        # Parses the elements of the first line and extract the dimensions of the map
        ...
        for i in range(x_max):
            l = [threading.Lock() for i in range(y_max)]
            lock_table.append(l)
    except:
    ...
    for c_mower in list_mowers:
        line = str(c_mower.x)+' '+str(c_mower.y)+' '+str(c_mower.direction+'\n')
        outF.write(line)
    outF.close()
    input_file.close()